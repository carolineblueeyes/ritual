...
import { Mic, X, MessageSquare, ArrowRight, Play, Compass, Check } from 'lucide-react';
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-50 flex items-end justify-center pointer-events-auto">
          ...
          >
            ...
            <div className="w-full bg-white/[0.02] border border-white/[0.05] rounded-3xl p-6 flex flex-col items-center justify-center min-h-[160px] relative overflow-hidden">
              {/* Animated gradient background per state */}
              <motion.div
                  ...
                  >
                    <div className="flex justify-between items-center border-b border-white/5 pb-2 relative">
                      <motion.div
                        ...
                        animate={{
                          background: recommendation.state === 'Shining'
                            ? "linear-gradient(135deg, rgba(52,211,153,0.15) 0%, transparent 100%)"
                            : recommendation.state === 'Balance'
                            ? "linear-gradient(135deg, rgba(251,191,36,0.15) 0%, transparent 100%)"
                            : recommendation.state === 'Tension'
                            ? "linear-gradient(135deg, rgba(251,146,60,0.15) 0%, transparent 100%)"
                            : recommendation.state === 'Overload'
                            ? "linear-gradient(135deg, rgba(251,113,133,0.15) 0%, transparent 100%)"
                            : "linear-gradient(135deg, rgba(156,163,175,0.15) 0%, transparent 100%)",
                        }}
                      ...
                      <span className="flex items-center space-x-1.5 text-[10px] bg-white/10 px-2 py-0.5 rounded-full font-mono">
                        <span className={`w-1.5 h-1.5 rounded-full ${
                          recommendation.state === 'Shining' ? 'bg-emerald-400' :
                          recommendation.state === 'Balance' ? 'bg-amber-400' :
                          recommendation.state === 'Tension' ? 'bg-orange-400' :
                          recommendation.state === 'Overload' ? 'bg-rose-400' : 'bg-gray-400'
                        }`} />
